...
public class SupportTeamInfo {

	public SupportTeamInfo() {
		super();
	}

	protected long supportTeamId;
	...
	protected Long supportTeamTypeId;

	public Long getSupportTeamTypeId() {
		return supportTeamTypeId;
	}

	public void setSupportTeamTypeId(Long supportTeamTypeId) {
		this.supportTeamTypeId = supportTeamTypeId;
	}

	protected String supportTeamTypeName;

	public String getSupportTeamTypeName() {
		return supportTeamTypeName;
	}

	public void setSupportTeamTypeName(String supportTeamTypeName) {
		this.supportTeamTypeName = supportTeamTypeName;
	}
